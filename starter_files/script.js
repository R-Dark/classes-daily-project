...
class Factory {
  ...
  customerBuild(color, options) {
    console.log("Building" + color + " " + this.trim + " " + this.model + " with the options  " + options);
  }
}
...
miataRf.customerBuild("black", ["HID lights", "sports suspension", "leather steering wheel", "heated seats", "adaptive cruise crontrol"] )
